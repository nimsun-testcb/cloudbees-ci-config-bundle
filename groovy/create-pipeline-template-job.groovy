...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/nimsun-testcb/pipeline-template-catalog.git");
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>nimsun-testcb</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/nimsun-testcb/pipeline-template-catalog.git</repositoryUrl>
              <traits>
